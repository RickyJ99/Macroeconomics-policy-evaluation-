...
From the plot of the time series we can see a mean reverting process, and so I will opt for the specifications with constant, becouse it is less restricitve.
