...
\begin{enumerate}
  \item $\Delta\,prod:\;\; \% $ change in global crude oil production
  \item $rpo_{t}$: the real price of oil
  \item $rea_{t}:$ index of the real economic activity
\end{enumerate}
...
Regarding the order of integration, we can say that the 
...
```{r point7, echo = FALSE, include=TRUE}
...
ex2 <- ex1[3:84, 1:3] # taking our the first 2 rows as they are N/As #
colnames(ex2) <- c("Delta production", 
"Real economic activity", "Real price of oil") # renaming columns #
